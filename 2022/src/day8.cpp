...
std::tuple<Point, Point, int, Point, int> iterInfo(const Grid &g,
                                                   const Direction dir) {
    // Returns the starting position, first delta direction vector, first
    // iteration dimensionality, second delta direction vector, second iteration
    // dimensionality
